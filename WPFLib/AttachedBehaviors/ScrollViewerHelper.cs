...
{
    /// <summary>
    /// Делает так что бы MouseWheel не проглатывался когда ScrollView ничего крутить не может
    /// </summary>
    public class ScrollViewerHelper
    {
        ...
        public static readonly DependencyProperty FixScrollingProperty =
            DependencyProperty.RegisterAttached("FixScrolling", typeof(bool), typeof(ScrollViewerHelper), new FrameworkPropertyMetadata(false, ScrollViewerHelper.OnFixScrollingPropertyChanged));
