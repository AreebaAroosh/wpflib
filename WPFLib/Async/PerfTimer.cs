...
namespace WPFLib.Misc
{
    ...
    public class PerfTimer
    {
        ...
        { // in milliseconds.            
            return GetMilliseconds(GetCurrentDurationInTicks());
        }
        ...
        /// <summary>
        /// Get the time between Start() and Now in the highest fidelity possible
        /// as defined by Windows QueryPerformanceFrequency.  Usually this is nanoseconds.
        /// </summary>
        /// <returns>High fidelity tick count</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1024")]
        public long GetCurrentDurationInTicks()
        { // in nanoseconds.
